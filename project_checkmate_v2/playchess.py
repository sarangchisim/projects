...
text6 = font.render('Build by team_z3r0', True, green)
            ...
            if color % 2 == 0:
                ...
                if not chessBoard.gameTiles[rows][column].pieceonTile.tostring() == "-":
                    img = pygame.image.load("./chessart/" +
                                           ...
                                           chessBoard.gameTiles[rows][column].pieceonTile.tostring().upper() + ".png")
                ...
                if not len(moves) == 0:
                    ...
                    for move in moves:
                        if move[0] == n and move[1] == m:
                            turn = turn + 1
                            if chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'R' or chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'r':
    ...
    while not quitgame:
        for event in pygame.event.get():
            ...
            if not turn % 2 == 0 and promotion == False:
                ...
                m = fy
                n = fx
                if chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'R':
                    chessBoard.gameTiles[y][x].pieceonTile.moved = True
                if not len(enpassant) == 0:
                    chessBoard.gameTiles[enpassant[0]][enpassant[1]].pieceonTile.enpassant = False
                    enpassant = []
